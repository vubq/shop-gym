<template>
  <el-container class="login-container">
    ...
    <el-card class="flipInY">
      <div slot="header" class="el-card-header">
        <!-- <lang-select class="lang-select"></lang-select> -->
        <div style="clear: both;"></div>
        <img src="../../../static/image/logo/logo.jpg" alt="" style="width: 30%;">
        <h2 class="login-title">NoLan Manage System</h2>
      </div>
      <el-form :model="loginForm" ref="loginForm" label-position="left" label-width="80px">
        <el-form-item label="Account" prop="userName" style="position:relative">
        ...
        <el-button style="margin-top: 30px;" type="primary" @click="onLogin('loginForm')" :loading="loading">Login</el-button>
      </el-form>
    </el-card>
...
.login-container
  ...
  right 0
  bottom 0
  background mix(#044289, #494166) url('../../../static/image/logo/background-opacity.png') center no-repeat
